<div
    class="flex-1 p-6 pb-12 lg:p-20 bg-rose-50 dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_rgb(244_63_94)] rounded-lg"
>
    <div class="flex flex-col space-y-4 text-xl">

        @if ($greetingMessage !== '')
            <p class="text-2xl font-medium">{{ $greetingMessage }}</p>
                ...
                <span class="inline-flex items-center justify-center align-bottom">
                    ...
                    >
                        <path
                            ...
                            class="fill-rose-900 dark:fill-[#F1F5F9]"
                        >
                        </path>
                        <path
                            fill-rule="evenodd"
                    ...
                    <span class="text-rose-500 text-sm ml-2">v.3</span>
                </span>
            </p>
        @endif
